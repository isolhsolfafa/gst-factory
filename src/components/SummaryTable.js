...
const holidays = [
  ...
  new Date('2025-01-27'), new Date('2025-01-28'), new Date('2025-01-29'), // 설날 연휴
  ...
  new Date('2025-10-06'), new Date('2025-10-07'), new Date('2025-10-08'), // 추석 연휴
  ...
  new Date('2026-06-03'), // 지방선거일 (임시공휴일)
